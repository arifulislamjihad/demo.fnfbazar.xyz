...
def send_facebook_purchase_event(order):
    """
    Sends Purchase Event to Facebook Conversion API with Enhanced Matching
    """
    ...
    # [UPDATED] 2. User Data with fbp & fbc
    user_data = {
        "ph": [phone_hash],
    }
    
    # Add Browser ID and Click ID if they exist
    if order.fbp:
...
class OrderAdmin(admin.ModelAdmin):
    ...
    # -------------------------------------------------------------
    # CSS TO MOVE FILTERS TO TOP & FORCE FULL WIDTH
    # -------------------------------------------------------------
    class Media:
        # Override default widgets.css if needed, but the view injection is stronger
        pass
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        custom_css = """
        <style>
            /* 1. HIDE the default right sidebar container */
            #changelist-filter {
