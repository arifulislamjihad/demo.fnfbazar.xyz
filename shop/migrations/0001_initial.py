# Generated by Django 6.0 on 2025-12-07 09:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_area', models.CharField(choices=[('dhaka', 'Dhaka City – ৳70'), ('outside', 'Outside Dhaka – ৳120')], default='dhaka', max_length=20)),
                ('delivery_charge', models.PositiveIntegerField(default=70)),
                ('payment_method', models.CharField(choices=[('cod', 'Cash On Delivery'), ('sslcommerz', 'SSLCommerz Online Payment')], default='cod', max_length=20)),
